...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='ruby_typhoon')
        ...
        self.parser.add_argument('--nz_T', type=int, default=100, help='size of the latent z vector')
        self.parser.add_argument('--ngf_T', type=int, default=64)
        self.parser.add_argument('--ndf_T', type=int, default=64)
        self.parser.add_argument('--nz_S', type=int, default=100, help='size of the latent z vector')
        self.parser.add_argument('--ngf_S', type=int, default=16)
        self.parser.add_argument('--ndf_S', type=int, default=16)
        ...
        self.parser.add_argument('--save_test_diagram', type=str,help='Save test diagram for demo.')
        self.parser.add_argument('--load_weights', action='store_true', help='Load the pretrained weights')
        self.parser.add_argument('--checkpoints_path', default=None, help='path to the folder contains checkpoints (for testing)')
        ...
        self.parser.add_argument('--w_con', type=float, default=20, help='Weight for reconstruction loss. default=50')
        ...
        ##
        # KD parameters
        self.parser.add_argument('--localization_method', type=str, default='gradients', help='gradients| smooth_grad | gpb')
        self.parser.add_argument('--localization_test', action='store_true', help='True:For Localization Test --- False:For Detection.')
        self.parser.add_argument('--lambdaa', type=float, default=0.7, help='weight of the KD loss')
        self.parser.add_argument('--w_kd', type=float, default=1, help='Weight for latent space loss. default=1')
        self.parser.add_argument('--w_kg', type=float, default=50, help='Weight for latent space loss. default=1')
    ...
    def parse(self):
        ...
        # save to the disk
        self.opt.name = "%s" % (self.opt.dataset)
